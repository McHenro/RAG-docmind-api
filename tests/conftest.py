...
def mock_db():
    ...
    In Django, the test runner creates a real test database automatically.
...
async def client(mock_db):
    ...
    async with AsyncClient(
        transport=ASGITransport(app=app), # tells httpx to talk directly to the FastAPI app in memory, skipping any real HTTP server or port. This is the FastAPI equivalent of Django's self.client in test cases.
